...
export const FlagShuffle = ({ targetCountry, onComplete }: FlagShuffleProps) => {
  ...
  useEffect(() => {
    ...
    const randomCountries = [...COUNTRIES]
      ...
      .slice(0, 20)
      .map(c => c.abbreviation.toLowerCase());
    
    setShuffledFlags([...randomCountries, targetCountry.abbreviation.toLowerCase()]);
        ...
        {!isFinishing ? (
          ...
          >
             <div className="relative group">
               <img 
                 src={`https://flagcdn.com/w320/${targetCountry.abbreviation.toLowerCase()}.png`} 
